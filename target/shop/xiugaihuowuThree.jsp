...
<body>
  <div class="page-content">
   <div class="user_Manager_style">
    ...
    <form id="xiuwuFrom" action="${pageContext.request.contextPath}/goods?method=updateThree" method="post">
         ...
         <button type="button" class="btn btn-info" style="margin-left: -10px" onclick="javascript:location.href='${pageContext.request.contextPath}/goods?method=viewThreeHouse'">返回</button>
         </div>
    </form>
