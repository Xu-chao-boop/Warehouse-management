...
<div class="page-content">
 ...
 <div class="user_Manager_style">
  ...
  <div class="Manager_style add_user_info">
    <div class="title_name">添加客户信息</div>
     <button class="btn btn-primary" type="button" id="Add_user_btn">添加客户</button>
      <br/>
      <br/>
      <h4 style="color: red">${requestScope.msg}</h4>
     <div id="Add_user_style" style="display:none">

     <form id="addSupplierForm" action="${pageContext.request.contextPath}/customer?method=add" method="post">
...
<!--    <div class="reset_style"><input name="reset" type="reset" value="重置" /class="btn btn-warning"> </div>-->
     <ul class="clearfix">
      ...
      <li style="margin-left: 100px;">
          ...
          <input name="customer" type="text" style="width: 160px" placeholder="请输入客户" required="required"/>
      </li>
         <br/>
         <br/>
         <br/>
      ...
      <li style="margin-left: 100px;">
         ...
         <br/>
             ...
             <div class="btn_operating">
                 ...
                 <button type="button" class="btn btn-info" onclick="javascript:location.href='${path}/customer?method=viewAll'">取消</button>
             </div>
      </form>
    ...
    <div class="Role_list">
     <table id="Role_list" cellpadding="0" cellspacing="0" class="table table-striped table-bordered table-hover">
            ...
            <div>
                <ul class="search_content clearfix">
                    <li>
                        ...
                        <input id="searchName" name="uname" type="text" placeholder="Search by customerName" value="${vo.query}" class="text_add" style="width:200px"/>
      ...
      <tbody>
<c:forEach items="${vo.list}" var="customer">
       <tr>
       <td width="10%">${customer.id}</td>
       <td width="30%">${customer.customer}</td>
       <td width="20%">${customer.name}</td>
       <td width="20%">${customer.phone}</td>
       <td width="20%">
        <button type="button" class="btn btn-info" onclick="javascript:location.href='${path}/customer?method=viewOne&id=${customer.id}'">修改</button>
        <button  type="button" class="btn btn-warning" onclick="javascript:location.href='${path}/customer?method=delete&id=${customer.id}'">删除</button>
        </td>
        </tr>
</c:forEach>
      </tbody>
...
<script>
    ...
    function viewAll(url) {
        ...
        //跳转
        window.location.href='${pageContext.request.contextPath}/customer?method=viewAll&query='+query;
    ...
    function first(url) {
        ...
        //跳转
        window.location.href='${pageContext.request.contextPath}/customer?method=viewAll&query='+query+"&pageNow="+pageNow;
    }
