...
<div class="page-content">
    <h3 class="header smaller lighter blue">一号仓库货物详细</h3>
    <div class="search_style">
        <div class="title_names">搜索查询</div>
        <ul class="search_content clearfix">
            <li><label class="lf">货物名称</label><input id="searchName" name="gname" type="text" placeholder="Search by name" value="${one.query}" class="text_add" style="width:200px;height: 35px"/></li>
    ...
    <div class="">
        <table id="" class="table table-striped table-bordered table-hover">
            ...
            <tbody id="test">
            <c:forEach items="${one.list}" var="goods">
                <tr class="data" align="center">
                    ...
                    <td><button type="button" class="btn btn-info" onclick="javascript:location.href='${path}/goods?method=viewOneOne&id=${goods.id}'">修改</button>
    ...
    <tr align="center">
        <td colspan="8">
            ...
            <input class="btn btn-success" type="button" id="pre" value="上一页"
                   onclick="pre('${path}')"/>&nbsp;&nbsp;
            <!-- 当前页 -->
            <input type="text" id="pageNow" value="${one.pageNow}" style="text-align:center"/>&nbsp;&nbsp;
            <input class="btn btn-success" type="button" value="跳转"
                   onclick="skip('${path}',${one.myPages})"/>&nbsp;&nbsp;
            <input class="btn btn-success" type="button" id="next" value="下一页"
                   onclick="next('${path}',${one.myPages})"/>&nbsp;&nbsp;
            <input class="btn btn-success" type="button" value="末页"
                   onclick="last('${path}',${one.myPages})"/>&nbsp;&nbsp;
        </td>
    </tr>
</div>
...
<script>
    ...
    function viewAll(url) {
        ...
        //跳转
        window.location.href='${pageContext.request.contextPath}/goods?method=viewOneHouse&query='+query;
    ...
    function first(url) {
        ...
        //跳转
        window.location.href='${pageContext.request.contextPath}/goods?method=viewOneHouse&query='+query+"&pageNow="+pageNow;
    }
    ...
    function deleteAll(url,str) {
        ...
        if(str=="all"){
            ...
            window.location.href = '${pageContext.request.contextPath}/goods?method=deleteOne'+s;  //&id=1&id=2&id=3
        }else{
            //单项删除  http://localhost:8899/items?code=delete&id=1
            window.location.href = '${pageContext.request.contextPath}/goods?method=deleteOne&id='+str;
        }
