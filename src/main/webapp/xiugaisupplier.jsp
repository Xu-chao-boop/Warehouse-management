  ...
  <div class="page-content">
   <div class="user_Manager_style">
     ...
     <div class=" Manager_style">
       <span class="title_name">修改供应商信息</span>
    ...
    <form id="xiuSupplierFrom" action="${pageContext.request.contextPath}/supplier?method=update" method="post">
         <div class="project_style">
          <ul class="Add_Manager_style clearfix">
           <li>
            <label class="label_name">供应商ID</label>
            <input name="id" type="text" placeholder="id" readonly="readonly"
                   class="text" value="${supplier.id}" style=" width:350px; "/>
           </li>
           <li>
            <label class="label_name">供应商名称</label>
            <input name="company" type="text" placeholder="请输入供应商名称" class="text"
                   required="required" value="${supplier.company}" style=" width:350px; "/><br/>
           ...
           <li>
            ...
            <input name="name" type="text" placeholder="请输入负责人姓名"
                   class="text" required="required" value="${supplier.name}" style=" width:350px; "/>
           </li>
           <li>
            <label class="label_name">联系电话</label>
            <input name="phone" type="text" placeholder="请输入联系电话"
                   class="text" required="required" value="${supplier.phone}" style=" width:350px; "/>
           </li>
          </ul>
         </div>
         <br/>
         ...
         <button type="button" class="btn btn-info" style="margin-left: -10px" onclick="javascript:location.href='${pageContext.request.contextPath}/supplier?method=viewAll'">返回</button>
         </div>
    </form>
